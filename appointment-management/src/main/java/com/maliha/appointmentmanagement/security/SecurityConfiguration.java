package com.maliha.appointmentmanagement.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/appointment/schedule/create","/appointment/{bookingId}/makeAvailable/byBookingId","/appointment/{slotId}/makeUnavailable","/appointment/{slotId}/makeAvailable/bySlotId","/appointment/slot/booked").hasAuthority("DOCTOR")
