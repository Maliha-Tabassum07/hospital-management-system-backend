...
public class ResearcherService {
    ...
    public void writeUserHealthDataToCsv(Long id, String filename) {
        List<HealthRecordViewDTO> allUserHealthData = userClient.getAllPatientHealthRecord();
        ...
        try (CSVWriter csvWriter = new CSVWriter(new FileWriter(new File(filename)))) {
            String[] header = {
                    ...
                    "BMI", "Date", "Sleep Hour", "Smoke", "Allergy"
            };
            csvWriter.writeNext(header);

            for (HealthRecordViewDTO userHealthDto : allUserHealthData) {
                String[] data = {
                        userHealthDto.getSpecialId(),
                        ...
                        String.valueOf(userHealthDto.getAllergy())
                };
